...
namespace BankingProjectFinal.Helpers
{
    public class ValidarHelper
    {
        public static bool ValidarPassword(string password, string loginPassword)
        {
        ...
        public static bool ValidarCedula(string drCedula)
        {
            // Is it null?
            if (drCedula == null)
                return false;
